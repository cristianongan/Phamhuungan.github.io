...
public class DocumentTypeTreeNode extends DefaultTreeNode<DocumentType> {
    ...
    public DocumentTypeTreeNode(DocumentType data, 
            DefaultTreeNode<DocumentType>[] children) {
        super(data, children);
    }
    ...
    public DocumentTypeTreeNode(DocumentType data, 
            List<? extends DefaultTreeNode<DocumentType>> children) {
        super(data, children);
    }

    public DocumentTypeTreeNode(DocumentType data, 
            List<? extends DefaultTreeNode<DocumentType>> children, boolean _open) {
        super(data, children);
