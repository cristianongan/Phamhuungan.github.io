...
public class Messagebox {
	...
	private static class ButtonListener implements SerializableEventListener<ClickEvent> {
		...
		public void onEvent(ClickEvent event) throws Exception {
			...
			this._listener.onEvent(new Event(event.getName(), event.getTarget(), btn != null ? btn.id : -1));
		}
	...
	/**
	 * The event that will be received by the listener when the user clicks a
	 * button.
	 * 
	 * @since 6.0.0
	 */
	 ...
	 */
	public static final String ERROR = "z-icon-circle messagebox-error";
	/**
	 ...
	 * Since 3.5.0, they are actually style class names to display the icon.
	 */
	public static final String EXCLAMATION = "z-icon-exclamation-triangle messagebox-exclamation";
	/** A IGNORE button. */
	 ...
	 * Since 3.5.0, they are actually style class names to display the icon.
	 */
	public static final String INFORMATION = "z-icon-info-circle messagebox-information";
	 ...
	 * Since 3.5.0, they are actually style class names to display the icon.
	 */
	public static final String QUESTION = "z-icon-question-circle messagebox-question";
	/** A Retry button. */
	...
	/**
	 * Shows a message box by specifying a message code, and returns what button is
	 * pressed.
	 *
	 * @param titleCode the message code for the title. If non-positive, the default
	 *                  title is used.
	 */
	 ...
	 *                  clicked. Ignored if null. It is useful if the event
	 *                  processing thread is disabled
	 *                  ({@link org.zkoss.zk.ui.util.Configuration#enableEventThread}).
	 *                  If the event processing thread is disabled, this method
	 *                  always return {@link #OK}. To know which button is pressed,
	 *                  you have to pass an event listener. Then, when the user
	 *                  clicks a button, the event listener is invoked. You can
	 *                  identify which button is clicked by examining the event name
	 *                  ({@link org.zkoss.zk.ui.event.Event#getName}) as shown in
	 *                  the following table. Alternatively, you can examine the
	 *                  value of {@link org.zkoss.zk.ui.event.Event#getData}, which
	 *                  must be an integer representing the button, such as
	 *                  {@link #OK}, {@link #YES} and so on.
	 *                  <table border="1">
	 *                  <tr>
	 *                  <td>Button</td>
	 *                  <td>Event Name</td>
	 ...
	 *                  <tr>
	 *                  <td>OK</td>
	 *                  <td>onOK ({@link #ON_OK})</td>
	 *                  </tr>
	 *                  <tr>
	 *                  <td>Cancel</td>
	 *                  <td>onCancel ({@link #ON_CANCEL})</td>
	 *                  </tr>
	 *                  <tr>
	 *                  <td>Yes</td>
	 *                  <td>onYes ({@link #ON_YES})</td>
	 *                  </tr>
	 *                  <tr>
	 *                  <td>No</td>
	 *                  <td>onNo ({@link #ON_NO})</td>
	 *                  </tr>
	 *                  <tr>
	 *                  <td>Retry</td>
	 *                  <td>onRetry ({@link #ON_RETRY})</td>
	 *                  </tr>
	 *                  <tr>
	 *                  <td>Abort</td>
	 *                  <td>onAbort ({@link #ON_ABORT})</td>
	 *                  </tr>
	 *                  <tr>
	 *                  <td>Ignore</td>
	 *                  <td>onIgnore ({@link #ON_IGNORE})</td>
	 *                  </tr>
	 *                  <tr>
	 *                  <td>The close button on the right-top corner (x)<br>
	 *                  since 5.0.2</td>
	 *                  <td>onClose</td>
	 *                  </tr>
	 *                  </table>
	 ...
	 *         {@link #IGNORE}). Note: if the event processing thread is disabled,
	 *         it always returns {@link #OK}.
	 * @since 3.0.4
	 */
	public static int show(int messageCode, int titleCode, int buttons, String icon, int focus,
	...
	/**
	 * Shows a message box and returns what button is pressed. A shortcut to
	 * show(message, null, buttons, INFORMATION, null, listener).
	 * 
	 * @since 6.0.0
	 */
	 ...
	 * @param buttons  an array of buttons to show. The buttons will be displayed in
	 *                 the same order in the array.
	 ...
	 *                 will gain the focus.
	 * @param listener the event listener which is invoked when a button is clicked.
	 *                 Ignored if null. It is useful if the event processing thread
	 *                 is disabled
	 *                 ({@link org.zkoss.zk.ui.util.Configuration#enableEventThread}).
	 *                 If the event processing thread is disabled (system default),
	 *                 this method always return {@link Button#OK}. To know which
	 *                 button is pressed, you have to pass an event listener. Then,
	 *                 when the user clicks a button, the event listener is invoked
	 *                 with an instance of {@link ClickEvent}. You can identify
	 *                 which button is clicked by examining
	 *                 {@link ClickEvent#getButton} or {@link ClickEvent#getName}.
	 *                 If the close button is clicked, the onClose event is sent and
	 *                 {@link ClickEvent#getButton} return null;
	 * @return the button being pressed. Note: if the event processing thread is
	 *         disabled (system default), it always returns {@link Button#OK}.
	 * @since 6.0.0
	 */
	...
	/**
	 * Shows a message box and returns what button is pressed. A shortcut to
	 * show(message, title, buttons, icon, null, listener).
	 * 
	 * @since 6.0.0
	 */
	 ...
	 *
	 * @param title     the title. If null, {@link WebApp#getAppName} is used.
	 * @param buttons   an array of buttons to show. The buttons will be displayed
	 ...
	 *                  which button is clicked by examining
	 *                  {@link ClickEvent#getButton} or {@link ClickEvent#getName}.
	 *                  If the close button is clicked, the onClose event is sent
	 *                  and {@link ClickEvent#getButton} return null;
	 * @return the button being pressed. Note: if the event processing thread is
	 *         disabled (system default), it always returns {@link Button#OK}.
	 * @since 6.0.0
	 */
	 ...
	 * @return the button being pressed. Note: if the event processing thread is
	 *         disabled (system default), it always returns {@link Button#OK}.
	 * @param params the parameters passed to the template. Ignored if null. Notice
	 *               it will override the default parameters if there is any
	 *               conflict. You could pass anything as long as the template
	 *               ({@link #setTemplate}) recognized. For the default template,
	 *               typical parameters are<br/>
	 *               <code>width</code>: the width of the dialog.<br/>
	 *               <code>icon</code>: the URI of the icon <code>sclass</code>: the
	 *               CSS class name of the top level Window (since 7.0.1)
	 * @since 6.0.0
	 */
	public static Button show(String message, String title, Button[] buttons, String[] btnLabels, String icon,
	 ...
	 *
	 * @param title   the title. If null, {@link WebApp#getAppName} is used.
	 * @param buttons a combination of {@link #OK}, {@link #CANCEL}, {@link #YES},
	 ...
	 *                 integer representing the button, such as {@link #OK},
	 *                 {@link #YES} and so on.
	 *                 <table border="1">
	 *                 <tr>
	 *                 <td>Button Name</td>
