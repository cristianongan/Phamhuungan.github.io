...
public interface UserDAO {
    ...
    /**
     * EN: Gets a list of Users where the LastName name contains the %string%
     * .<br>
     *
    ...
    /**
     * EN: Get a list of Users by its emailaddress with the like SQL
     * operator.<br>
     *
    ...
    public void saveOrUpdateAll(Collection<User> users) throws
            DataAccessException;
