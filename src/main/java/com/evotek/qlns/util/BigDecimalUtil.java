...
public class BigDecimalUtil {
	 ...
	 * @since
	 *        <ul type="square">
	 *        <li><b>RoundingMode.UP:</b> Làm tròn lên theo giá trị tuyệt đối
	 *        (2.5->3, 1.1->2, -1.1->-2)</li>
	 *        <li><b>RoundingMode.DOWN:</b> Làm tròn xuống theo giá trị tuyệt
	 *        đối(2.5->2, 1.1->1, -1.1->-1)</li>
	 *        <li><b>RoundingMode.CEILING:</b> Làm tròn lên theo giá trị thực
	 *        (2.5->3, 1.1->2, -1.1->-1)</li>
	 *        <li><b>RoundingMode.FLOOR:</b> Làm tròn xuống theo giá trị thực
	 *        (2.5->2, 1.1->1, -1.1->-2)</li>
	 *        <li><b>RoundingMode.HALF_UP:</b> Làm tròn từ 0.5 trở lên (2.5->3,
	 *        1.1->1, -1.5->-2, 2.6->3)</li>
	 *        <li><b>RoundingMode.HALF_DOWN:</b> Làm tròn từ 0.5 trở xuống (2.5->2,
	 *        1.1->1, -1.5->-1, 2.6->3)</li>
	 *        <li><b>RoundingMode.HALF_EVEN:</b> Làm tròn từ 0.5 trở lên với phần
	 *        nguyên lẻ, làm tròn từ 0.5 trở xuống với phần nguyên chẵn(2.5->2,
	 *        1.6->2, -1.6->-2)</li>
	 *        </ul>
	 */
