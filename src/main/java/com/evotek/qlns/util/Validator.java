...
public class Validator {
	...
	private static Pattern _codeStringPattern = Pattern.compile("[_a-zA-Z0-9]*");
	...
	private static Pattern _numberPattern = Pattern.compile("[+-]?\\d*(\\.\\d+)?");
	...
	public static boolean isIPAddress(String ipAddress) {
		...
		return matcher.matches() || IPAddressUtil.isIPv6LiteralAddress(ipAddress);
	}
