...
public class Validator {
    ...
    /**
     * Returns
     * <code>true</code> if the string is an email address. The only
    ...
    /**
     * Returns
     * <code>true</code> if the string is an alphanumeric name, meaning it
    ...
    /**
     * Returns
     * <code>true</code> if string consists only of upper and lower case English
     * letters.
     *
    ...
    /**
     * Returns
     * <code>true</code> if the date is valid in the Gregorian calendar.
     *
    ...
    /**
     * Returns
     * <code>true</code> if the string consists of only digits between 0 and 9
     * (inclusive).
     *
     * @param s the string to check
    ...
    /**
     * Returns
     * <code>true</code> if the string is a valid domain name. See RFC-1034
    ...
    /**
     * Returns
     * <code>true</code> if the string is a valid email address.
     *
    ...
    /**
     * Returns
     * <code>true</code> if the character is a special character in an email
     * address.
     *
     * @param c the character to check
    ...
    /**
     * Returns
     * <code>true</code> if the string is a hexidecimal number. At present the
     * only requirement is that the string is not
     * <code>null</code>; it does not actually check the format of the string.
     *
     * @param s the string to check
    ...
    /**
     * Returns
     * <code>true</code> if the string is an HTML document. The only requirement
     * is that it contain the opening and closing html tags.
     *
     * @param s the string to check
    ...
    /**
     * Returns
     * <code>true</code> if the string is a valid IPv4 IP address.
     *
    ...
    /**
     * Returns
     * <code>true</code> if the date is valid in the Julian calendar.
     *
     * @param month the month (0-based, meaning 0 for January)
     * @param day the day of the month
     * @param year the year
    ...
    /**
     * Returns
     * <code>true</code> if the string contains a valid number according to the
     * Luhn algorithm, commonly used to validate credit card numbers.
     *
    ...
    /**
     * Returns
     * <code>true</code> if the string is a name, meaning it contains nothing
     * but English letters and spaces.
     *
     * @param name the string to check
    ...
    /**
     * Returns
     * <code>true</code> if the long number object is not
     * <code>null</code>, meaning it is neither a
     * <code>null</code> reference or zero.
     *
    ...
    /**
     * Returns
     * <code>true</code> if the object is not
     * <code>null</code>, using the rules from {@link #isNotNull(Long)} or
     * {@link #isNotNull(String)} if the object is one of these types.
     *
    ...
    /**
     * Returns
     * <code>true</code> if the array is not
     * <code>null</code>, meaning it is neither a
     ...
     * <code>null</code>, meaning it is not a
    ...
    /**
     * Returns
     * <code>true</code> if the collection is not
     *
    ...
    /**
     * Returns
     * <code>true</code> if the long number object is
     * <code>null</code>, meaning it is either a
     * <code>null</code> reference or zero.
     *
     * @param l the long number object to check
    ...
    /**
     * Returns
     * <code>true</code> if the object is
     * <code>null</code>, using the rules from {@link #isNull(Long)} or
     * {@link #isNull(String)} if the object is one of these types.
     *
     * @param obj the object to check
    ...
    /**
     * Returns
     * <code>true</code> if the array is
     * <code>null</code>, meaning it is either a
     * <code>null</code> reference or empty.
     *
     * @param array the array to check
    ...
    /**
     * Returns
     * <code>true</code> if the collection is
     * <code>null</code>, meaning it is either a
     * <code>null</code> reference or empty.
     *
     * @param collection the collection to check
    ...
    /**
     * Returns
     * <code>true</code> if the string is a decimal integer number, meaning it
    ...
    /**
     * Returns
     * <code>true</code> if the string is a valid password, meaning it is at
    ...
    /**
     * Returns
     * <code>true</code> if the string is a valid phone number. The only
    ...
    /**
     * Returns
     * <code>true</code> if the string is a valid URL based on the rules in
     * {@link java.net.URL}.
     *
    ...
    /**
     * Returns
     * <code>true</code> if the string is a valid variable name in Java.
     *
