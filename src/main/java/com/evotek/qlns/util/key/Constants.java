...
public class Constants {
    ...
    public static final String STYLE_COLUMN_MULTILINE   =
            "white-space: normal;word-wrap:break-word;text-wrap:none;";
...
//    manhnn1_end
    ...
    public static final String TREE_DOCUMENT_TYPE_PAGE  = 
            "/html/pages/common/documentTypeTree.zul";
    public static final String TREE_DEPARTMENT_PAGE  = 
            "/html/pages/common/departmentTree.zul";
    /**
     * Content Type
     */
    ...
    public static final String RESET_PASSWORD  
            = "RESET_PASSWORD";
    public static final String VERIFY_RESET_PASSWORD  
            = "VERIFY_RESET_PASSWORD";
    public static final String VERIFY_RESET_PASSWORD_USER_DEACTIVE  
            = "VERIFY_RESET_PASSWORD_USER_DEACTIVE";
}
