...
public class LanguageKeys {
    ...
    public static final String NO_RECORD_FOUNND =
    ...
    public static final String OPTION =
            "common.option";
    public static final String USER_INFOMATION =
            "common.user.infomation";
    ...
    public static final String DESCRIPTION =
            "common.description";
    public static final String ASSIGN_RIGHT =
            "common.assign.right";
    ...
    public static final String MENU_MAIN =
            "menu.main";
    public static final String MENU_CONTROL_PANEl =
            "menu.control.panel";
    public static final String MENU_ITEM_CATEGORY_MANAGEMENT =
            "menu.item.category.management";
    public static final String MENU_ITEM_MANAGER_DOCUMENT =
            "menu.item.manager.document";

    /**
     * Title
     */
    public static final String TITLE_ADD =
            "title.add";
    public static final String TITLE_EDIT =
            "title.edit";
    public static final String TITLE_EDIT_MENU =
            "title.edit.menu";
    public static final String TITLE_EDIT_RIGHT =
            "title.edit.right";
    public static final String TITLE_EDIT_ROLE =
            "title.edit.role";
    public static final String TITLE_EDIT_GROUP =
            "title.edit.group";
    public static final String TITLE_EDIT_USER =
            "title.edit.user";
    public static final String TITLE_EDIT_DOCUMENT =
            "title.edit.document";
    public static final String TITLE_DETAIL_DOCUMENT =
            "title.detail.document";
    public static final String TITLE_ADD_DOCUMENT =
            "title.add.document";
    public static final String TITLE_EDIT_DOCUMENT_TYPE =
            "title.edit.document.type";
    public static final String TITLE_MANAGER_RIGHT =
            "title.manager.right";
    public static final String TITLE_EDIT_STAFF =
            "title.edit.staff";
    public static final String TITLE_STAFF_DETAIL =
            "title.staff.detail";
    public static final String TITLE_EDIT_SALARY_LANDMARK =
            "title.edit.salary.landmark";
    public static final String TITLE_EDIT_WORK_PROCESS =
            "title.edit.work.process";
    public static final String TITLE_EDIT_DEPARTMENT =
     ...
     * Message
     */
    public static final String MESSAGE_WELLCOME_USER =
            "message.wellcome.user";
    public static final String MESSAGE_AVATAR =
            "message.avatar";
    ...
    public static final String MESSAGE_QUESTION_SAVE_CHANGE =
            "message.question.save.change";
    ...
    public static final String MESSAGE_INFOR_ADD =
            "message.infor.add";
    public static final String MESSAGE_INFOR_SAVE_CHANGE =
            "message.infor.save.change";
    ...
    public static final String MESSAGE_INPUT_NUMBER_ONLY =
            "message.input.number.only";
    public static final String MESSAGE_VALUE_MUST_IN_RANGE =
            "message.value.must.in.range";
    public static final String MESSAGE_NOT_EXIST =
            "message.not.exist";
    public static final String MESSAGE_NO_RECORD_EXPORT =
            "message.no.record.export";
    public static final String MESSAGE_CANNOT_LOCK_YOURSELF =
            "message.cannot.lock.yourself";
    public static final String MESSAGE_VERIFY_CODE_INCORRECT =
            "message.verify.code.incorrect";
    public static final String MESSAGE_IN_USE_CANNOT_DELETE =
            "message.in.use.cannot.delete";
    public static final String MESSAGE_ALL_IN_USE_CANNOT_DELETE =
            "message.all.in.use.cannot.delete";
    public static final String MESSAGE_ONE_OF_CHARACTER =
            "message.one.of.character";
    public static final String MESSAGE_NEW_PASSWORD_DO_NOT_CONTAIN_OLD_PASSWORD =
            "message.new.password.do.not.contain.old.password";
    public static final String MESSAGE_CHECK_EXISTED_DATA_BEFORE_SAVE =
            "message.check.existed.data.before.save";
    public static final String MESSAGE_NOTIFICATION_TOTAL =
            "message.notification.total";
    ...
    public static final String GROUP_NAME =
            "group.name";
    public static final String RIGHT_NAME =
            "right.name";
    ...
    public static final String DATE_OF_BIRTH =
            "date.of.birth";
    public static final String PLACE_OF_BIRTH =
            "place.of.birth";
    ...
    public static final String ADDRESS =
            "address";
    public static final String ROLE_ASSIGNED_TO_USER =
    ...
    public static final String PUBLISHER =
            "publisher";
    public static final String PUBLIC_DATE =
            "public.date";
    public static final String DOCUMENT_ATTACH =
            "document.attach";
    public static final String NOT_CLASSIFY =
            "not.classify";
    public static final String PERMANENT_RESIDENCE =
            "permanent.residence";
    public static final String CURRENT_RESIDENCE =
            "current.residence";
    public static final String CONTRACT_NUMBER =
            "contract.number";
    public static final String TAX_CODE =
            "tax.code";
    public static final String INSURANCE_BOOK_NUMBER =
            "insurance.book.number";
    public static final String PAID_INSURANCE_PLACE =
            "paid.insurance.place";
    ...
    public static final String IDENTITY_CARD =
            "identity.card";
    public static final String GRANT_PLACE =
            "grant.place";
    ...
    public static final String CONTRACT_TYPE =
            "contract.type";
    public static final String CONTRACT_DURATION =
            "contract.duration";
    public static final String SALARY =
            "salary";
    public static final String WORK_AT =
            "work.at";
    public static final String CONTRACT_EXPIRED =
            "contract.expired";
    public static final String BIRTH_DAY =
            "birth.day";
    public static final String EXTEND_CONTRACT =
            "extend.contract";
    public static final String DEPARMENT_NAME =
            "deparment.name";
    public static final String REGISTER_SUCCESS =
            "register.success";
    public static final String REGISTER_FAIL =
            "register.fail";
    public static final String REGISTER_LIMITED =
            "register.limited";
    public static final String RETRIVE_SUCCESS =
            "retrive.success";
    public static final String CAPTCHA_NOT_MATCH =
            "captcha.not.match";
    public static final String YOU_MUST_ACCEPT_USER_AGREEMENT =
            "you.must.accept.user.agreement";
}
