...
public class DocumentTypeServiceImpl implements DocumentTypeService {
    ...
    private static final Logger _log =
            LogManager.getLogger(DocumentTypeServiceImpl.class);
    ...
    public void updateDeleteOrdinal(ServletContext context, DocumentType parent, 
        ...
        if (Validator.isNull(parent)) {
            ...
            for(DocumentType docType: siblings){
                ...
                documentTypeDAO.saveOrUpdate(docType, true);
            }
        } else {
            ...
            documentTypeDAO.saveOrUpdate(parent, true);
        }
    }
    
    @Override
    public void delete(DocumentType documentType) {
        documentTypeDAO.deleteDocType(documentType);
    }
...
//            updateDelDocTypeMap(context, root, parent);
            ...
            List<Document> docs = documentDAO.getDocumentListByIdList(docTypeGroupIds,
    ...
    public Map<Long, List<DocumentType>> getDocTypeMap(ServletContext context, 
            boolean doUpdate) {
        Map<Long, List<DocumentType>> docTypeMap
                = (Map<Long, List<DocumentType>>) context.getAttribute("docTypeMap");
        ...
        if (Validator.isNull(docTypeMap) || doUpdate) {
            ...
            roots.add(new DocumentType(-1L, "Chưa phân loại", 
                    Constants.Z_ICON_RANDOM));
    ...
    private void getDocTypeMap(DocumentType root,
            Map<Long, List<DocumentType>> docTypeMap) {
...
//            childs.add(docType);
    ...
    public void updateDocTypeMap(ServletContext context, DocumentType docType, 
        ...
        if((parentDocType == null 
                && oldParentDocType == null)
                ||(parentDocType!=null 
                && parentDocType.equals(oldParentDocType))){
            this.saveOrUpdate(docType, true);
