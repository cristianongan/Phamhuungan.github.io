...
public class UserPrincipalImpl extends org.springframework.security.core.userdetails.User
     ...
     */
    public UserPrincipalImpl(User user, Collection<String> roles,
            Collection<GrantedAuthority> grantedAuthorities)
            throws IllegalArgumentException {

        super(user.getUserName(), user.getPassword(), true,
...
//                true, true, true, grantedAuthorities);
        ...
        this.userToken = DigestUtils.md5DigestAsHex(userId.toString().getBytes());
        } else
            this.userToken = "";
        this.user = user;
        this.roles = roles;
