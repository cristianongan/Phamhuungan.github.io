...
public class AssignRightController extends BasicController<Window> implements Serializable {
	...
	private static final Logger _log = LogManager.getLogger(AssignRightController.class);
...
//                Events.sendEvent("onLoadGroups", winTemp, null);
	...
	public void searchRight() throws Exception {
		try {
			List<Right> rights = this.categoryService.getRightByCategoryId(this.group.getCategoryId());
