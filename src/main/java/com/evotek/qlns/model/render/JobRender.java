...
public class JobRender implements ListitemRenderer<Job>{
    ...
    private void renderEditing(Listitem item, Job job, int index) {
        ...
        item.appendChild(ComponentUtil.createTextboxListcell(job.getJobTitle(), 
                job.getJobId()+"-"+"job-title"));
    ...
    private Listcell _getNoneEditAction(final Listitem item, final Job job, 
            final int index) {
    ...
    private Listcell _getEditAction(final Listitem item, final Job job, 
            final int index) {
        ...
        Button btnSave = ComponentUtil.createButton(
                Labels.getLabel(LanguageKeys.BUTTON_SAVE), ComponentUtil.EDIT_TOOLTIP, 
                Constants.Z_ICON_SAVE, Constants.BLUE);
        ...
        Button btnCancel = ComponentUtil.createButton(
                Labels.getLabel(LanguageKeys.BUTTON_CANCEL), ComponentUtil.CALCEL_TOOLTIP, 
