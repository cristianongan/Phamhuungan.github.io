...
public class GroupRender implements RowRenderer<Group>{
	...
	public void render(Row row, Group group, int index) throws Exception {
        row.appendChild(ComponentUtil.createCell(
...
//                Constants.STYLE_TEXT_ALIGN_CENTER));
    ...
    private Hlayout _getAction(Group group){
        ...
        hlayout.appendChild(ComponentUtil.createButton(null,
                ...
                Events.ON_CLICK, EDIT_GROUP_PAGE,
                _createParameterMap(group), Constants.Z_ICON_PENCIL, 
                Constants.BLUE));
        ...
        if(Values.STATUS_ACTIVE.equals(status)){
            ...
            hlayout.appendChild(ComponentUtil.createButton(this.winTemp,
                    ...
                    "onDeleteGroups", group, Constants.Z_ICON_TRASH_O,
                    Constants.RED));
        }
        ...
        hlayout.appendChild(ComponentUtil.createButton(null,
                ...
                ASSIGN_RIGHT_PAGE, _createParameterMap(group), 
    ...
    private static final String ASSIGN_RIGHT_PAGE =
            "/html/pages/manager_menu/assign_right.zul";
}
