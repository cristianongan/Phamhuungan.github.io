...
//                Constants.STYLE_TEXT_ALIGN_CENTER));
        item.appendChild(ComponentUtil.createListcell(GetterUtil.getDate(
                salaryLm.getFromDate(), DateUtil.SHORT_DATE_PATTERN),
                Constants.STYLE_TEXT_ALIGN_CENTER));
        item.appendChild(ComponentUtil.createListcell(GetterUtil.getDate(
                salaryLm.getToDate(), DateUtil.SHORT_DATE_PATTERN),
                Constants.STYLE_TEXT_ALIGN_CENTER));
        item.appendChild(ComponentUtil.createListcell(GetterUtil.getFormat(
                salaryLm.getSalary()), Constants.STYLE_TEXT_ALIGN_CENTER));
    ...
    private Listcell _getAction(SalaryLandmark salaryLm) {
        ...
        hlayout.appendChild(ComponentUtil.createButton(null,
                ...
                ADD_EDIT_SALARY_LANDMARK_PAGE, _createParameterMap(salaryLm, 
                        Labels.getLabel(LanguageKeys.TITLE_EDIT_SALARY_LANDMARK)),
