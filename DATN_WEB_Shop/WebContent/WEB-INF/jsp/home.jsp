...
<div id="carouselBlk">
	<div id="myCarousel" class="carousel slide">
		<div class="carousel-inner">
		  ...
		  <div class="container">
			<a href="user/register"><img style="height: 10%" src="themes/images/carousel/p1.jpg" alt="special offers"/></a>
		  ...
		  <div class="item">
		  <div class="container">
			<a href="user/register"><img style="height: 10%" src="themes/images/carousel/p2.jpg" alt=""/></a>
				<div class="carousel-caption">
				  <h4>Second Thumbnail label</h4>
				  <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
				</div>
		  ...
		  <div class="item">
		  <div class="container">
			<a href="user/register"><img style="height: 10%" src="themes/images/carousel/p3.jpeg" alt=""/></a>
			<div class="carousel-caption">
				  <h4>Second Thumbnail label</h4>
				  <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
				</div>
		   ...
		   <div class="item">
		   <div class="container">
			<a href="user/register"><img  style="height: 10%" src="themes/images/carousel/p4.jpg" alt=""/></a>
			<div class="carousel-caption">
				  <h4>Second Thumbnail label</h4>
				  <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
				</div>
